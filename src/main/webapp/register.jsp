...
<body>
  ...
  <div class=" h-screen bg-cover bg-center min-h-screen flex items-center justify-center gap-32 px-10 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600">
